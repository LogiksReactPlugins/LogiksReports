import { require_react_dom } from "./chunk-JPFIJ2ZJ.js";
import { __commonJS, __toESM, require_react } from "./chunk-3A6WRQ5K.js";
...
function createStaticHandler(routes, opts) {
  ...
  async function query(
    ...
    let respondOrStreamStaticContext = (ctx) => {
      return stream
        ? stream(requestContext, () => Promise.resolve(ctx))
        : respond
          ? respond(ctx)
          : ctx;
    };
            ...
            if (stream) {
              let res2 = await stream(
                ...
                async (revalidationRequest) => {
                  ...
                  return isResponse(result3)
                    ? result3
                    : { location: location2, basename, ...result3 };
                },
              );
              return res2;
            }
  ...
  return React8.createElement(
    ...
    keyedLinks.map(({ key, link }) =>
      isPageLinkDescriptor(link)
        ? React8.createElement(PrefetchPageLinks, { key, ...link })
...
try {
  if (isBrowser) {
    window.__reactRouterVersion = "7.7.0"; // @ts-expect-error
  }
} catch (e) {}
  ...
  return React42.createElement(
    ...
    React42.createElement(
      ...
      React42.createElement(
        ...
        React42.createElement(RouterProvider, {
          router: router2,
